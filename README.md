...
| Area | Improvements |
| --- | --- |
| Questing | Eligible low-level quest starters retain visible `!` markers so XP-bearing quests are easier to discover; quest markers refresh as objectives change; completed quests point to their configured turn-in NPCs; incomplete objective POIs stay with their matching verified client build; and multi-quest NPCs continue offering the next available quest without requiring the player to reopen the dialog. The Death Knight starting sequence includes targeted repairs for Olrun visibility, Orbaz's Acherus recovery option, Light's Point cannon target behavior, and the upper Ebon Hold battle-phase transition. When High Overlord Saurfang fails to render at Warsong Hold, the visible Garrosh Hellscream offers the generic **The Defense of Warsong Hold** variant as a progression fallback. **Foolish Endeavors** restores Shadowstalker Getry's descent and Saurfang's combat assistance against Varidus. **The Wondrous Bloodspore** and **From the Mouth of Madness** restore incorrectly converted, lootable quest-object nodes. **A Prayer and a Wing** restores Blaithe's guaranteed Ancient Feather drop. **Coward Delivery** restores its summoned deserter, lost-escort recovery, flare signal, Alliance officer handoff, and delivery credit. **Through the Dream** restores Fandral Staghelm's recoverable escort, destination-gated delivery credit, and the missing Alysra hand-in NPC. **Flames from Above** restores Tholo's Horn, the Emerald Flameweaver flyover, and the missing Twilight Infiltrator camp. Rocket Rescue is semi-functional: its visible balloon follows the authored route and targeted payloads advance both objectives, although passenger attachment and projectile visuals remain imperfect. |
